package com.cold0.realestatemanager.screens.simulator
...
import com.cold0.realestatemanager.screens.editestate.OutlinedTextFieldLazy
				...
				TopBarReturn(this, "Simulator") {
					Box(Modifier.fillMaxSize())
					{
						Row(Modifier
							...
							var mensuality by remember { mutableStateOf(1302) }
							...
							Column(Modifier.padding(16.dp)) {
								...
								Text(mensuality.toString(), style = MaterialTheme.typography.h1)
							}
						}
					}
				}
